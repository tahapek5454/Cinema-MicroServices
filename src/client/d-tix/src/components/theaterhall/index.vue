<template>
    <div class="tw-text-xs tw-w-[20rem] tw-h-[14rem] tw-border tw-border-component-border tw-shadow-md tw-shadow-component-border  md:tw-text-base md:tw-w-[40rem] md:tw-h-[22rem] tw-bg-component-color tw-rounded-lg tw-flex tw-flex-col">
        ...
        <div class="tw-px-4 tw-my-auto tw-flex tw-justify-between">
            <div class="tw-flex tw-flex-col tw-space-y-4 md:tw-space-y-6">
                <div class=" tw-font-bold tw-text-white tw-bg-rose-900 tw-w-4 tw-h-3 md:tw-w-6 md:tw-h-6 tw-rounded-full tw-text-center tw-flex tw-justify-center tw-items-center">
                    A
                </div>
                <div class="tw-text-white tw-font-bold  tw-bg-rose-900 tw-w-4 tw-h-3 md:tw-w-6 md:tw-h-6 tw-rounded-full tw-text-center tw-flex tw-justify-center tw-items-center">
                    B
                </div>
                <div class="tw-text-white tw-font-bold  tw-bg-rose-900 tw-w-4 tw-h-3 md:tw-w-6 md:tw-h-6 tw-rounded-full tw-text-center tw-flex tw-justify-center tw-items-center">
                    C
            ...
            <div class="tw-flex tw-flex-col tw-space-y-4 md:tw-space-y-6">
                ...
                <div class="tw-flex tw-space-x-2 md:tw-space-x-4 tw-justify-start">
                    <TheaterSeat :key="key" :seatNumber="item.value" v-for="(item, key) in filteredSeatsForC"/>
                </div>
                <div class="tw-flex tw-space-x-2 md:tw-space-x-4 tw-justify-start">
                    <TheaterSeat :key="key" :seatNumber="item.value" v-for="(item, key) in filteredSeatsForD"/>
                </div>
                <div class="tw-flex tw-space-x-2 md:tw-space-x-4 tw-justify-start">
                    <TheaterSeat :key="key" :seatNumber="item.value" v-for="(item, key) in filteredSeatsForE"/>
                </div>               
            </div>
            <div class="tw-flex tw-flex-col tw-space-y-4 md:tw-space-y-6">
                <div class="tw-text-white tw-font-bold tw-bg-rose-900 tw-w-4 tw-h-3 md:tw-w-6 md:tw-h-6 tw-rounded-full tw-text-center tw-flex tw-justify-center tw-items-center">
