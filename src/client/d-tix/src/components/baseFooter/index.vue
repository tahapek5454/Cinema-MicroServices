<template>                                              
    <footer class="w-full">
        <div class="w-full px-0 sm:px-0 lg:px-0">
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div class="col-span-full mb-10 ml-5 lg:col-span-1">
                    <div>
                        <img width="50px" src="@/assets/YENILOGO.svg" alt="Logo">
                    </div>
                    <div class="flex mt-4 space-x-4 sm:justify-start lg:mt-7 ">
                ...
                <div class="lg:mx-auto text-left">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Vizyonda</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6">Alien</li>
                        <li class="mb-6">Bayi</li>
                        <li class="mb-6">Garfield</li>
                        <li class="mb-6">Ters Yüz</li>
                    </ul>
                </div>
                <div class="lg:mx-auto text-left">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Yakında</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6">Siccin 7</li>
                        <li class="mb-6">Tuzak</li>
                        <li class="mb-6">New York'ta Bir Gece</li>
                        <li class="mb-6">Murat Göğebakan : Kalbim Yaralı</li>
                    </ul>
                </div>
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Kurumsal</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6">Hakkımızda</li>
                        <li class="mb-6">İnsan Kaynakları</li>
                        <li class="mb-6">İşlem Rehberi</li>
                        <li class="mb-6">Özel Etkinlik Talepleri</li>
                        <li class="mb-6">Toplu Bilet Satış</li>
                    </ul>
                </div>
