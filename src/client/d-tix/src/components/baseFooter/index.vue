        ...
        <div class="tw-w-full">
            <div class="tw-grid tw-grid-cols-2 sm:tw-grid-cols-4 lg:tw-grid-cols-4 tw-gap-3 tw-gap-y-8 md:tw-gap-8 tw-py-10 tw-max-w-sm tw-mx-auto tw-sm:max-w-3xl lg:tw-max-w-full">
                <div class="tw-col-span-full tw-mb-10 tw-ml-5 lg:tw-col-span-1">
                    ...
                    <div class="tw-flex tw-mt-4 tw-space-x-4 sm:tw-justify-start lg:tw-mt-7 ">
                        <a href="javascript:;"  class="tw-w-8 tw-h-8 tw-rounded-full tw-transition-all tw-duration-500 tw-flex tw-justify-center tw-items-center tw-bg-[#33CCFF] tw-hover:bg-gray-900">
                        ...
                        <a href="javascript:;"  class="tw-relative tw-w-8 tw-h-8 tw-rounded-full tw-transition-all tw-duration-500 tw-flex tw-justify-center tw-items-center tw-bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        ">
                        ...
                        <a href="javascript:;"  class="tw-relative tw-w-8 tw-h-8 tw-rounded-full tw-transition-all tw-duration-500 tw-flex tw-justify-center tw-items-center tw-bg-[#337FFF]  tw-hover:bg-gray-900 ">
                            <svg class="tw-w-[1rem] tw-h-[1rem] tw-text-white" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="javascript:;"  class="tw-relative tw-w-8 tw-h-8 tw-rounded-full tw-transition-all tw-duration-500 tw-flex tw-justify-center tw-items-center tw-bg-[#FF0000]  tw-hover:bg-gray-900 ">
                            <svg class="tw-w-[1.25rem] tw-h-[0.875rem] tw-text-white" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lg:tw-mx-auto tw-text-left">
                    <h4 class="tw-text-lg tw-text-gray-900 tw-font-medium tw-mb-7">Vizyonda</h4>
                    <ul class="tw-text-sm  tw-transition-all tw-duration-500">
                        <li class="tw-mb-6">Alien</li>
                        <li class="tw-mb-6">Bayi</li>
                        <li class="tw-mb-6">Garfield</li>
                        <li class="tw-mb-6">Ters Yüz</li>
                    </ul>
                </div>
                <div class="lg:tw-mx-auto tw-text-left">
                    ...
                    <ul class="tw-text-sm  tw-transition-all tw-duration-500">
                        ...
                        <li class="tw-mb-6">New York'ta Bir Gece</li>
                        <li class="tw-mb-6">Murat Göğebakan : Kalbim Yaralı</li>
                    </ul>
                </div>
                <div class="lg:tw-mx-auto tw-text-left ">
                    <h4 class="tw-text-lg tw-text-gray-900 tw-font-medium tw-mb-7">Kurumsal</h4>
                    <ul class="tw-text-sm  tw-transition-all tw-duration-500">
                        <li class="tw-mb-6">Hakkımızda</li>
                        <li class="tw-mb-6">İnsan Kaynakları</li>
                        <li class="tw-mb-6">İşlem Rehberi</li>
                        <li class="tw-mb-6">Özel Etkinlik Talepleri</li>
                        <li class="tw-mb-6">Toplu Bilet Satış</li>
                    </ul>
                </div>
